...
export const PostCard = ({ post, onDelete }) => {
  ...
  return (
    <article className="bg-slate-900/60 border border-slate-800/80 rounded-3xl p-5 space-y-4 shadow-sm hover:border-slate-700/80 transition-colors">
      {/* Header */}
      ...
      {/* Media Image */}
      {post.image && (
        <div className="relative rounded-2xl overflow-hidden bg-slate-950 border border-slate-800 aspect-[16/10] max-h-96">
          <img
            src={post.image}
            alt="Post media"
